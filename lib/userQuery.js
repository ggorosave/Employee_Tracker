...
class UserQuery {
    ...
    async addToDatabase(tableName, columnNames, questionMarks, ...parameters) {
    ...
    async addEmployeePrompt() {
        ...
        return inquirer
            .prompt([
                ...
                // calls the addToDatabase function and sets department name as params
                this.addToDatabase('employee', 'first_name, last_name, role_id, manager_id', '?, ?, ?, ?', firstName, lastName, roleId, managerId);
            })
    };
